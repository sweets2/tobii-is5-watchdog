...
if /I not "%~dp0"=="C:\Scripts\" (
    ...
    for %%F in (Tobii-Watchdog.ps1 Tobii-Monitor.ps1 Tobii-Sentinel.ps1 Tobii-Tray.ps1 Tobii-Tray.vbs Tobii-RunHidden.vbs Tobii-CalReapply.cs CyclePort.ps1 Install-TobiiWatchdog.ps1 Uninstall-TobiiWatchdog.ps1 README.md FINDINGS.md) do (
